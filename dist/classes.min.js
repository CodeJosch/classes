...
d.Class.prototype._classname="Class";d.Class.prototype.defaults={};d.Class.prototype.toString=function(){return this._classname+"("+d.serialize(this.props())+")"};d.Class.prototype.instanceOf=function(a){for(var c=this;c;){if(c._classname===a)return!0;if(!c._super)break;c=c._super.prototype}return!1};d.Class.prototype.clone=function(){return new this(d.clone(this.props()))};d.Class.prototype.init=function(a){var c={};d.merge(c,d.clone(this.defaults),a);this.setProp=function(b,a){c[b]=a};this.unsetProp=
function(b){"undefined"!==typeof c[b]&&delete c[b]};this.prop=function(b){return c[b]};this.props=function(){return c}};d.Class.createInstance=function(a){return new this(a)};d.Class.extend=function(){var a,c;2===arguments.length&&"string"===typeof arguments[0]?(a=arguments[0],c="function"===typeof arguments[1]?{init:arguments[1]}:arguments[1]):c=1===arguments.length?"function"===typeof arguments[0]?{init:arguments[0]}:arguments[0]:{};var b=c.init?c.init:void 0,f=function(b){if(!this._initializing){var a=
this._super,c=[];for(this.init&&c.push(this.init);a;)a.prototype.init&&c.push(a.prototype.init),a=a.prototype._super;for(a=c.length-1;0<=a;a--)c[a].call(this,b)}};this.prototype._initializing=!0;var e=f.prototype=new this;e._super=this;"undefined"!==typeof a&&(e._classname=a);delete this.prototype._initializing;var g;g=c.defaults?d.merge({},e.defaults,c.defaults):d.merge({},e.defaults);d.merge(e,this,c);e.init=b;e.defaults=d.clone(g);f.extend=function(){return d.Class.extend.apply(f,arguments)};f.createInstance=
function(){return d.Class.createInstance.apply(f,arguments)};if(a){a=a.split(".");c=d;b=0;for(e=a.length-1;b<e;b++)c[a[b]]||(c[a[b]]={}),c=c[a[b]];c[a[a.length-1]]=f}return f}})("undefined"!==typeof module?module.exports={}:classes={});
